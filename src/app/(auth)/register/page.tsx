        ...
        <form onSubmit={handleSubmit} className="p-8 w-full max-w-sm space-y-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2 rounded border cursor-pointer ${form.role === "PATIENT" ? "bg-blue-600 text-white" : ""}`}
            >
              Patient
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded border cursor-pointer ${form.role === "DOCTOR" ? "bg-blue-600 text-white" : ""}`}
            >
              Doctor
            </button>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white rounded px-3 py-2 disabled:opacity-50 cursor-pointer font-medium"
          >
